...
if [ $# -eq 2 ]; then
    ...
    # use Git Bash
    echo "/c/Program Files/dotnet/dotnet" build -v:d $MY_DIR/PTSystem_PosixAndroid.vcxproj -property:VCTargetsPath=$MY_DIR/MSBuild/VCTargets/ -property:Configuration=$1 -property:Platform=$2
